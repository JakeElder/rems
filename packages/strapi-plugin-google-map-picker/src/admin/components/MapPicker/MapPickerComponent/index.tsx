        ...
        <Status variant="warning" size="S" showBullet={false}>
          <Typography>
            <Typography>
              Missing:{" "}
              {!config.apiKey && (
                <Typography fontWeight="bold">apiKey</Typography>
              )}
              {!config.apiKey && !config.defaultCenter ? " and " : null}
              {!config.defaultCenter && (
                <Typography fontWeight="bold">defaultCenter</Typography>
              )}
            </Typography>
          </Typography>
          <br />
          <Link
            href="https://github.com/spalz/strapi-plugin-google-map-picker"
            isExternal
          >
