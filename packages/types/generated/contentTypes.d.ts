...
export interface ApiFeaturedPropertyListFeaturedPropertyList
  ...
  collectionName: "featured_property_lists";
  info: {
...
export interface ApiIndoorFeatureIndoorFeature extends Schema.CollectionType {
  ...
  attributes: {
    name: Attribute.String;
    properties: Attribute.Relation<
      "api::indoor-feature.indoor-feature",
      "manyToMany",
      "api::property.property"
    >;
...
export interface ApiLotFeatureLotFeature extends Schema.CollectionType {
...
export interface ApiOutdoorFeatureOutdoorFeature extends Schema.CollectionType {
  ...
  attributes: {
    name: Attribute.String & Attribute.Required & Attribute.Unique;
    properties: Attribute.Relation<
      "api::outdoor-feature.outdoor-feature",
      "manyToMany",
      "api::property.property"
    >;
...
export interface ApiPropertyProperty extends Schema.CollectionType {
  ...
  attributes: {
    ...
    purchasePrice: Attribute.Integer;
    bedrooms: Attribute.Integer;
    bathrooms: Attribute.Integer;
    area: Attribute.Integer;
    location: Attribute.String &
      Attribute.CustomField<"plugin::google-map-picker.place">;
    rentalPrice: Attribute.Integer;
    availableToPurchase: Attribute.Boolean &
      Attribute.Required &
      Attribute.DefaultTo<false>;
    availableToRent: Attribute.Boolean &
      Attribute.Required &
      Attribute.DefaultTo<false>;
    yearBuilt: Attribute.Integer;
    address: Attribute.Text;
    indoor_features: Attribute.Relation<
      "api::property.property",
      "manyToMany",
      "api::indoor-feature.indoor-feature"
    >;
    lot_features: Attribute.Relation<
      "api::property.property",
      "manyToMany",
      "api::lot-feature.lot-feature"
    >;
    outdoor_features: Attribute.Relation<
      "api::property.property",
      "manyToMany",
      "api::outdoor-feature.outdoor-feature"
    >;
    ...
    >;
    view_types: Attribute.Relation<
      "api::property.property",
      "manyToMany",
      "api::view-type.view-type"
    >;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
...
export interface ApiViewTypeViewType extends Schema.CollectionType {
...
declare module "@strapi/strapi" {
  export module Shared {
    export interface ContentTypes {
      ...
      "api::indoor-feature.indoor-feature": ApiIndoorFeatureIndoorFeature;
      "api::lot-feature.lot-feature": ApiLotFeatureLotFeature;
      "api::outdoor-feature.outdoor-feature": ApiOutdoorFeatureOutdoorFeature;
      "api::property.property": ApiPropertyProperty;
      "api::property-type.property-type": ApiPropertyTypePropertyType;
      "api::view-type.view-type": ApiViewTypeViewType;
    }
  }
}
